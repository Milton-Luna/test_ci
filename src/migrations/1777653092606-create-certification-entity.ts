...
export class CreateCertificationEntity1777653092606 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."certifications_status_enum" AS ENUM('Active', 'Pending', 'Rejected')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "certifications" ADD CONSTRAINT "FK_5f947b6b81e1873742fe2975b81" FOREIGN KEY ("id_business") REFERENCES "business"("id_business") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "certifications" DROP CONSTRAINT "FK_5f947b6b81e1873742fe2975b81"`,
    );
